    ...
    grid.innerHTML = products.map(p => {
      ...
      <div class="product-card" data-id="${p.id}" onclick="openProduct('${p.id}')">
        ...
        <div class="product-card-body">
          ...
          <div class="product-card-price">${settings.currencySymbol || ''}${Number(p.price).toLocaleString()}</div>
          <button class="product-card-buy" onclick="buyNow(event, '${p.id}')">
...
function openProduct(id) {
    ...
    // Buy button
    document.getElementById('modalBuyBtn').onclick = () => buyNow(null, id);
